...
###
#
AppConfig[:search_user_secret] = "d570b949e9bf9898b4bbecfb1c748d6e"
AppConfig[:public_user_secret] = "0c1bdb33900d03a41f2c810debe771ec"
AppConfig[:staff_user_secret] = "d216843b6efbec6e501315d7669608fa"
AppConfig[:frontend_cookie_secret] = "74149827e7e73cbd7d7d0c28dcd637fe"
AppConfig[:public_cookie_secret] = "38c391ba7b27b2ca6da9207384b516b4"
## Set your database name and credentials here.  Example:
AppConfig[:db_url] = "jdbc:mysql://localhost:3306/archivesspace?user=as&password=l1v3rp00l&useUnicode=true&characterEncoding=UTF-8"
##
...
## set it to something else below.
AppConfig[:public_url] = "http://lac-archives-live.is.ed.ac.uk:8081"
#
...
##
AppConfig[:data_directory] = File.join("/home/lacddt/solr/data")
#
...
AppConfig[:pui_email_smtp_settings] = {
      address:              'bulkmailrelay.ucs.ed.ac.uk',
      port:                 25,
      domain:               'ed.ac.uk',
#      user_name:            '',
 #     password:             '',
